...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">remedion-front documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-b14ce097ea2917279a9da562ece81a91"' : 'data-target="#xs-components-links-module-AppModule-b14ce097ea2917279a9da562ece81a91"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-b14ce097ea2917279a9da562ece81a91"' :
                                            'id="xs-components-links-module-AppModule-b14ce097ea2917279a9da562ece81a91"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/ConsultaProdutoComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ConsultaProdutoComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/ReservasComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ReservasComponent</a>
                                            </li>
                                            <li class="link">
